...
const unsigned int ACC_SAMPLE_RATE = 1;
...
const unsigned int ACC_BANDWIDTH = -1;
  // imu.settings.accel.bandwidth = 0; // BW = 408Hz
  // [highResEnable] enables or disables high resolution 
  // mode for the acclerometer.
const boolean ACC_HIGH_RESOLUTION = false;
...
const unsigned int GYRO_SAMPLE_RATE = 4; // 7.12 datasheet: ODR_G[2:0]
...
const boolean GYRO_HPF_ENABLE = true;
  // [HPFEnable] enables or disables the high-pass filter


const int GYRO_LOW_HPF_CUTOFF = 9; // HPF disabled
